        ...
        <nav class="top-0 left-0 w-full fixed flex items-center justify-start font-bold bg-laravel text-white h-24 mt-0 opacity-100">
            <ul class="fixed flex space-x-6 ml-4 mt-2 text-lg">
                <li>
                    <a
                    href="/"
                    class="flex mt-1 hover:text-black"
                
                    ><i class="fa-solid fa-camera-retro fa-2x"></i></a
                >
                ...
                <li>
                    <a
                    href="/event/create"
                    class="flex bg-black rounded text-white py-2 px-5 hover:text-laravel"
                    >Post Event</a
                >
                ...
                <li>
                    <a
                    href="/types"
                    class="flex bg-laravel rounded text-white py-2 px-2 hover:text-black"
                    >Manage Types</a
                >
                </li>
                @endauth
