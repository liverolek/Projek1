        ...
        <form method="POST" action="/process/{{ $process->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="description"
                    value="{{ $process->description }}" placeholder="Short text displayed on timeline" />
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea class="border border-gray-200 rounded p-2 w-full" name="long_description" rows="10">{{ $process->long_description }}
            </textarea>
